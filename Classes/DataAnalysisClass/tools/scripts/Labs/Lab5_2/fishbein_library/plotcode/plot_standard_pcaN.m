function [h pc themean]= plot_standard_pcaN(standards, N, colors, standard_number, standard_replicant)

 % first, interpret our inputs

colorlist = 'bgrcmyk'; % these are the defaults
pointlist = 'os^dos^';
if nargin>2 % if there are at least 2 inputs to the function`
...
for k=stand_nums
	...
	scatterplot(pcaprojection(1:N,:)','color',colorlist(col_number),'marker', pointlist(col_number),'shrink',0,'markersize',5);
