...
for trial = 1:Ntrials    % iterate through trials
    ...
    W = W - mean(mean(W))-0.1/Ncells;  % normalize to enforce a global balance
end
% Now move to testing memory of inputs in same manner, but no update of W
errorprob = 0.0; % produce degradation if non-zero
% Now test a pattern
