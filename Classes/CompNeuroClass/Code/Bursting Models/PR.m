...
g_Na = 0.30e-3;   % specific sodium conductance
g_K = 0.15e-3;    % specific potassium conductance

g_Ca = 0.1e-3;    % calcium conductance
...
g_Link = 2e-6; % conductance linking dendrite and soma divided by total membrane area
g_Link = 200e-6; % conductance linking dendrite and soma divided by total membrane area
...
S_frac = 0.25;  % fraction of total membrane area that is soma
