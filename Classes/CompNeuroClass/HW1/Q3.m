...
% 
% This code is for problem number 3 on homework 1. It is a simulation on a
% leaky integrate and fire neuron responding rate to varying levels in current with noise.
...
sigma = .005;      %Coefficient of random noise
...
title(['Spike Frequency vs. Current    Sigma = ' str])