function [finalnorm] = finalalgorithm_subtractbackground(filename, pcaN)
...
subtract_standards=subtractbackgroundfluor(standards);
...
interp_standards = modify_standards(subtract_standards,'interpolateNdim_meltcurve');
