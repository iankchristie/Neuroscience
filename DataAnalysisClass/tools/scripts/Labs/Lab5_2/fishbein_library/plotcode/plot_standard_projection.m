function [h] = plot_standard_projection(standards, pc, themean, colors, standard_number, standard_replicant)

 % first, interpret our inputs

colorlist = 'bgrcmyk'; % these are the defaults
pointlist = 'os^dos^';
if nargin>3 % if there are at least 2 inputs to the function`
