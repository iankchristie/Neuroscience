function [resultStruct] = unidirectionalTrainingISN(timeStruct, inputStruct, modelStruct, plasticityStruct)
...
disp('Down');
[m, Lde, Ldi, Rde, Rdi] = RunTrialWithOutPlasticity(timeStruct, Down, inputMatrix, modelStruct);
